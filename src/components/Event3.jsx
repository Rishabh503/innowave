...
const pastEvents = [
  {
    ...
    date: "March 15, 2024",
    category: "Cultural",
    description: "3-day extravaganza featuring dance competitions, music concerts, and art exhibitions with participation from 15+ colleges.",
    highlights: ["2000+ attendees", "Celebrity performance", "12 competitions"],
  ...
  },
  {
    ...
    date: "July 22, 2024",
    category: "Technical",
    description: "48-hour coding marathon where students built innovative solutions for real-world problems. Prizes worth $5000.",
    highlights: ["120 teams", "Industry mentors", "Live demos"],
    imageUrl: "/api/placeholder/800/500",
